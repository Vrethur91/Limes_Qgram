 ...
 * overlap.
 * source: https://code.google.com/p/duke/source/browse/src/main/java/no/priv/garshol/duke/comparators/QGramComparator.java
 * @since 1.0
 */
public class QGramComparator {
  ...
  public enum Tokenizer {
    ...
    public Set<String> qgrams(String s, int q) {
      System.out.println("Uknown tokenizer: " + this);
      return null;
    }
  }
}